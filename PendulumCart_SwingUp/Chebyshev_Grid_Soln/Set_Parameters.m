...
%% Parameters for multiple shooting
    ...
    %   0 = none            --  Passes convergence tests
    %   1 = force squared
    %   2 = total work
    %   3 = abs(force)
    %   4 = D(force) squared
    %   5 = force^4    (crazy idea!)
    
    %Smoothing:  (only needed for cost functions that use smoothing)
    P.MS.smoothing = 0.1;
...
% these bounds.
    ...
    P.Bnd.state = [...
        -1, 1;     %Bounds on horizontal position of the cart
...
%% Parameters for dynamics
    ...
    P.Dyn.dynamics_func = @Pendulum_Cart_Dynamics_Forced;
