...
M(1,2,:) = - d2.*l1.*m2.*cos(th1 - th2) - l1.*l2.*m3.*cos(th1 - th2) - l1.*l2.*m4.*cos(th1 - th2) - l1.*l2.*m5.*cos(th1 - th2) - l1.*l2.*m6.*cos(th1 - th2) - l1.*l2.*m7.*cos(th1 - th2) - l1.*l2.*m8.*cos(th1 - th2) - l1.*l2.*m9.*cos(th1 - th2) - l1.*l2.*m10.*cos(th1 - th2);
M(1,3,:) = - d3.*l1.*m3.*cos(th1 - th3) - l1.*l3.*m4.*cos(th1 - th3) - l1.*l3.*m5.*cos(th1 - th3) - l1.*l3.*m6.*cos(th1 - th3) - l1.*l3.*m7.*cos(th1 - th3) - l1.*l3.*m8.*cos(th1 - th3) - l1.*l3.*m9.*cos(th1 - th3) - l1.*l3.*m10.*cos(th1 - th3);
M(1,4,:) = - d4.*l1.*m4.*cos(th1 - th4) - l1.*l4.*m5.*cos(th1 - th4) - l1.*l4.*m6.*cos(th1 - th4) - l1.*l4.*m7.*cos(th1 - th4) - l1.*l4.*m8.*cos(th1 - th4) - l1.*l4.*m9.*cos(th1 - th4) - l1.*l4.*m10.*cos(th1 - th4);
M(1,5,:) = - d5.*l1.*m5.*cos(th1 - th5) - l1.*l5.*m6.*cos(th1 - th5) - l1.*l5.*m7.*cos(th1 - th5) - l1.*l5.*m8.*cos(th1 - th5) - l1.*l5.*m9.*cos(th1 - th5) - l1.*l5.*m10.*cos(th1 - th5);
M(1,6,:) = - d6.*l1.*m6.*cos(th1 - th6) - l1.*l6.*m7.*cos(th1 - th6) - l1.*l6.*m8.*cos(th1 - th6) - l1.*l6.*m9.*cos(th1 - th6) - l1.*l6.*m10.*cos(th1 - th6);
M(1,7,:) = - d7.*l1.*m7.*cos(th1 - th7) - l1.*l7.*m8.*cos(th1 - th7) - l1.*l7.*m9.*cos(th1 - th7) - l1.*l7.*m10.*cos(th1 - th7);
M(1,8,:) = - d8.*l1.*m8.*cos(th1 - th8) - l1.*l8.*m9.*cos(th1 - th8) - l1.*l8.*m10.*cos(th1 - th8);
M(1,9,:) = - d9.*l1.*m9.*cos(th1 - th9) - l1.*l9.*m10.*cos(th1 - th9);
M(1,10,:) = -d10.*l1.*m10.*cos(th1 - th10);
M(2,1,:) = - d2.*l1.*m2.*cos(th1 - th2) - l1.*l2.*m3.*cos(th1 - th2) - l1.*l2.*m4.*cos(th1 - th2) - l1.*l2.*m5.*cos(th1 - th2) - l1.*l2.*m6.*cos(th1 - th2) - l1.*l2.*m7.*cos(th1 - th2) - l1.*l2.*m8.*cos(th1 - th2) - l1.*l2.*m9.*cos(th1 - th2) - l1.*l2.*m10.*cos(th1 - th2);
M(2,2,:) = - I2 - d2.^2.*m2 - l2.^2.*m3 - l2.^2.*m4 - l2.^2.*m5 - l2.^2.*m6 - l2.^2.*m7 - l2.^2.*m8 - l2.^2.*m9 - l2.^2.*m10;
M(2,3,:) = - d3.*l2.*m3.*cos(th2 - th3) - l2.*l3.*m4.*cos(th2 - th3) - l2.*l3.*m5.*cos(th2 - th3) - l2.*l3.*m6.*cos(th2 - th3) - l2.*l3.*m7.*cos(th2 - th3) - l2.*l3.*m8.*cos(th2 - th3) - l2.*l3.*m9.*cos(th2 - th3) - l2.*l3.*m10.*cos(th2 - th3);
M(2,4,:) = - d4.*l2.*m4.*cos(th2 - th4) - l2.*l4.*m5.*cos(th2 - th4) - l2.*l4.*m6.*cos(th2 - th4) - l2.*l4.*m7.*cos(th2 - th4) - l2.*l4.*m8.*cos(th2 - th4) - l2.*l4.*m9.*cos(th2 - th4) - l2.*l4.*m10.*cos(th2 - th4);
M(2,5,:) = - d5.*l2.*m5.*cos(th2 - th5) - l2.*l5.*m6.*cos(th2 - th5) - l2.*l5.*m7.*cos(th2 - th5) - l2.*l5.*m8.*cos(th2 - th5) - l2.*l5.*m9.*cos(th2 - th5) - l2.*l5.*m10.*cos(th2 - th5);
M(2,6,:) = - d6.*l2.*m6.*cos(th2 - th6) - l2.*l6.*m7.*cos(th2 - th6) - l2.*l6.*m8.*cos(th2 - th6) - l2.*l6.*m9.*cos(th2 - th6) - l2.*l6.*m10.*cos(th2 - th6);
M(2,7,:) = - d7.*l2.*m7.*cos(th2 - th7) - l2.*l7.*m8.*cos(th2 - th7) - l2.*l7.*m9.*cos(th2 - th7) - l2.*l7.*m10.*cos(th2 - th7);
M(2,8,:) = - d8.*l2.*m8.*cos(th2 - th8) - l2.*l8.*m9.*cos(th2 - th8) - l2.*l8.*m10.*cos(th2 - th8);
M(2,9,:) = - d9.*l2.*m9.*cos(th2 - th9) - l2.*l9.*m10.*cos(th2 - th9);
M(2,10,:) = -d10.*l2.*m10.*cos(th2 - th10);
M(3,1,:) = - d3.*l1.*m3.*cos(th1 - th3) - l1.*l3.*m4.*cos(th1 - th3) - l1.*l3.*m5.*cos(th1 - th3) - l1.*l3.*m6.*cos(th1 - th3) - l1.*l3.*m7.*cos(th1 - th3) - l1.*l3.*m8.*cos(th1 - th3) - l1.*l3.*m9.*cos(th1 - th3) - l1.*l3.*m10.*cos(th1 - th3);
M(3,2,:) = - d3.*l2.*m3.*cos(th2 - th3) - l2.*l3.*m4.*cos(th2 - th3) - l2.*l3.*m5.*cos(th2 - th3) - l2.*l3.*m6.*cos(th2 - th3) - l2.*l3.*m7.*cos(th2 - th3) - l2.*l3.*m8.*cos(th2 - th3) - l2.*l3.*m9.*cos(th2 - th3) - l2.*l3.*m10.*cos(th2 - th3);
M(3,3,:) = - I3 - d3.^2.*m3 - l3.^2.*m4 - l3.^2.*m5 - l3.^2.*m6 - l3.^2.*m7 - l3.^2.*m8 - l3.^2.*m9 - l3.^2.*m10;
M(3,4,:) = - d4.*l3.*m4.*cos(th3 - th4) - l3.*l4.*m5.*cos(th3 - th4) - l3.*l4.*m6.*cos(th3 - th4) - l3.*l4.*m7.*cos(th3 - th4) - l3.*l4.*m8.*cos(th3 - th4) - l3.*l4.*m9.*cos(th3 - th4) - l3.*l4.*m10.*cos(th3 - th4);
M(3,5,:) = - d5.*l3.*m5.*cos(th3 - th5) - l3.*l5.*m6.*cos(th3 - th5) - l3.*l5.*m7.*cos(th3 - th5) - l3.*l5.*m8.*cos(th3 - th5) - l3.*l5.*m9.*cos(th3 - th5) - l3.*l5.*m10.*cos(th3 - th5);
M(3,6,:) = - d6.*l3.*m6.*cos(th3 - th6) - l3.*l6.*m7.*cos(th3 - th6) - l3.*l6.*m8.*cos(th3 - th6) - l3.*l6.*m9.*cos(th3 - th6) - l3.*l6.*m10.*cos(th3 - th6);
M(3,7,:) = - d7.*l3.*m7.*cos(th3 - th7) - l3.*l7.*m8.*cos(th3 - th7) - l3.*l7.*m9.*cos(th3 - th7) - l3.*l7.*m10.*cos(th3 - th7);
M(3,8,:) = - d8.*l3.*m8.*cos(th3 - th8) - l3.*l8.*m9.*cos(th3 - th8) - l3.*l8.*m10.*cos(th3 - th8);
M(3,9,:) = - d9.*l3.*m9.*cos(th3 - th9) - l3.*l9.*m10.*cos(th3 - th9);
M(3,10,:) = -d10.*l3.*m10.*cos(th3 - th10);
M(4,1,:) = - d4.*l1.*m4.*cos(th1 - th4) - l1.*l4.*m5.*cos(th1 - th4) - l1.*l4.*m6.*cos(th1 - th4) - l1.*l4.*m7.*cos(th1 - th4) - l1.*l4.*m8.*cos(th1 - th4) - l1.*l4.*m9.*cos(th1 - th4) - l1.*l4.*m10.*cos(th1 - th4);
M(4,2,:) = - d4.*l2.*m4.*cos(th2 - th4) - l2.*l4.*m5.*cos(th2 - th4) - l2.*l4.*m6.*cos(th2 - th4) - l2.*l4.*m7.*cos(th2 - th4) - l2.*l4.*m8.*cos(th2 - th4) - l2.*l4.*m9.*cos(th2 - th4) - l2.*l4.*m10.*cos(th2 - th4);
M(4,3,:) = - d4.*l3.*m4.*cos(th3 - th4) - l3.*l4.*m5.*cos(th3 - th4) - l3.*l4.*m6.*cos(th3 - th4) - l3.*l4.*m7.*cos(th3 - th4) - l3.*l4.*m8.*cos(th3 - th4) - l3.*l4.*m9.*cos(th3 - th4) - l3.*l4.*m10.*cos(th3 - th4);
M(4,4,:) = - I4 - d4.^2.*m4 - l4.^2.*m5 - l4.^2.*m6 - l4.^2.*m7 - l4.^2.*m8 - l4.^2.*m9 - l4.^2.*m10;
M(4,5,:) = - d5.*l4.*m5.*cos(th4 - th5) - l4.*l5.*m6.*cos(th4 - th5) - l4.*l5.*m7.*cos(th4 - th5) - l4.*l5.*m8.*cos(th4 - th5) - l4.*l5.*m9.*cos(th4 - th5) - l4.*l5.*m10.*cos(th4 - th5);
M(4,6,:) = - d6.*l4.*m6.*cos(th4 - th6) - l4.*l6.*m7.*cos(th4 - th6) - l4.*l6.*m8.*cos(th4 - th6) - l4.*l6.*m9.*cos(th4 - th6) - l4.*l6.*m10.*cos(th4 - th6);
M(4,7,:) = - d7.*l4.*m7.*cos(th4 - th7) - l4.*l7.*m8.*cos(th4 - th7) - l4.*l7.*m9.*cos(th4 - th7) - l4.*l7.*m10.*cos(th4 - th7);
M(4,8,:) = - d8.*l4.*m8.*cos(th4 - th8) - l4.*l8.*m9.*cos(th4 - th8) - l4.*l8.*m10.*cos(th4 - th8);
M(4,9,:) = - d9.*l4.*m9.*cos(th4 - th9) - l4.*l9.*m10.*cos(th4 - th9);
M(4,10,:) = -d10.*l4.*m10.*cos(th4 - th10);
M(5,1,:) = - d5.*l1.*m5.*cos(th1 - th5) - l1.*l5.*m6.*cos(th1 - th5) - l1.*l5.*m7.*cos(th1 - th5) - l1.*l5.*m8.*cos(th1 - th5) - l1.*l5.*m9.*cos(th1 - th5) - l1.*l5.*m10.*cos(th1 - th5);
M(5,2,:) = - d5.*l2.*m5.*cos(th2 - th5) - l2.*l5.*m6.*cos(th2 - th5) - l2.*l5.*m7.*cos(th2 - th5) - l2.*l5.*m8.*cos(th2 - th5) - l2.*l5.*m9.*cos(th2 - th5) - l2.*l5.*m10.*cos(th2 - th5);
M(5,3,:) = - d5.*l3.*m5.*cos(th3 - th5) - l3.*l5.*m6.*cos(th3 - th5) - l3.*l5.*m7.*cos(th3 - th5) - l3.*l5.*m8.*cos(th3 - th5) - l3.*l5.*m9.*cos(th3 - th5) - l3.*l5.*m10.*cos(th3 - th5);
M(5,4,:) = - d5.*l4.*m5.*cos(th4 - th5) - l4.*l5.*m6.*cos(th4 - th5) - l4.*l5.*m7.*cos(th4 - th5) - l4.*l5.*m8.*cos(th4 - th5) - l4.*l5.*m9.*cos(th4 - th5) - l4.*l5.*m10.*cos(th4 - th5);
M(5,5,:) = - I5 - d5.^2.*m5 - l5.^2.*m6 - l5.^2.*m7 - l5.^2.*m8 - l5.^2.*m9 - l5.^2.*m10;
M(5,6,:) = - d6.*l5.*m6.*cos(th5 - th6) - l5.*l6.*m7.*cos(th5 - th6) - l5.*l6.*m8.*cos(th5 - th6) - l5.*l6.*m9.*cos(th5 - th6) - l5.*l6.*m10.*cos(th5 - th6);
M(5,7,:) = - d7.*l5.*m7.*cos(th5 - th7) - l5.*l7.*m8.*cos(th5 - th7) - l5.*l7.*m9.*cos(th5 - th7) - l5.*l7.*m10.*cos(th5 - th7);
M(5,8,:) = - d8.*l5.*m8.*cos(th5 - th8) - l5.*l8.*m9.*cos(th5 - th8) - l5.*l8.*m10.*cos(th5 - th8);
M(5,9,:) = - d9.*l5.*m9.*cos(th5 - th9) - l5.*l9.*m10.*cos(th5 - th9);
M(5,10,:) = -d10.*l5.*m10.*cos(th5 - th10);
M(6,1,:) = - d6.*l1.*m6.*cos(th1 - th6) - l1.*l6.*m7.*cos(th1 - th6) - l1.*l6.*m8.*cos(th1 - th6) - l1.*l6.*m9.*cos(th1 - th6) - l1.*l6.*m10.*cos(th1 - th6);
M(6,2,:) = - d6.*l2.*m6.*cos(th2 - th6) - l2.*l6.*m7.*cos(th2 - th6) - l2.*l6.*m8.*cos(th2 - th6) - l2.*l6.*m9.*cos(th2 - th6) - l2.*l6.*m10.*cos(th2 - th6);
M(6,3,:) = - d6.*l3.*m6.*cos(th3 - th6) - l3.*l6.*m7.*cos(th3 - th6) - l3.*l6.*m8.*cos(th3 - th6) - l3.*l6.*m9.*cos(th3 - th6) - l3.*l6.*m10.*cos(th3 - th6);
M(6,4,:) = - d6.*l4.*m6.*cos(th4 - th6) - l4.*l6.*m7.*cos(th4 - th6) - l4.*l6.*m8.*cos(th4 - th6) - l4.*l6.*m9.*cos(th4 - th6) - l4.*l6.*m10.*cos(th4 - th6);
M(6,5,:) = - d6.*l5.*m6.*cos(th5 - th6) - l5.*l6.*m7.*cos(th5 - th6) - l5.*l6.*m8.*cos(th5 - th6) - l5.*l6.*m9.*cos(th5 - th6) - l5.*l6.*m10.*cos(th5 - th6);
M(6,6,:) = - I6 - d6.^2.*m6 - l6.^2.*m7 - l6.^2.*m8 - l6.^2.*m9 - l6.^2.*m10;
M(6,7,:) = - d7.*l6.*m7.*cos(th6 - th7) - l6.*l7.*m8.*cos(th6 - th7) - l6.*l7.*m9.*cos(th6 - th7) - l6.*l7.*m10.*cos(th6 - th7);
M(6,8,:) = - d8.*l6.*m8.*cos(th6 - th8) - l6.*l8.*m9.*cos(th6 - th8) - l6.*l8.*m10.*cos(th6 - th8);
M(6,9,:) = - d9.*l6.*m9.*cos(th6 - th9) - l6.*l9.*m10.*cos(th6 - th9);
M(6,10,:) = -d10.*l6.*m10.*cos(th6 - th10);
M(7,1,:) = - d7.*l1.*m7.*cos(th1 - th7) - l1.*l7.*m8.*cos(th1 - th7) - l1.*l7.*m9.*cos(th1 - th7) - l1.*l7.*m10.*cos(th1 - th7);
M(7,2,:) = - d7.*l2.*m7.*cos(th2 - th7) - l2.*l7.*m8.*cos(th2 - th7) - l2.*l7.*m9.*cos(th2 - th7) - l2.*l7.*m10.*cos(th2 - th7);
M(7,3,:) = - d7.*l3.*m7.*cos(th3 - th7) - l3.*l7.*m8.*cos(th3 - th7) - l3.*l7.*m9.*cos(th3 - th7) - l3.*l7.*m10.*cos(th3 - th7);
M(7,4,:) = - d7.*l4.*m7.*cos(th4 - th7) - l4.*l7.*m8.*cos(th4 - th7) - l4.*l7.*m9.*cos(th4 - th7) - l4.*l7.*m10.*cos(th4 - th7);
M(7,5,:) = - d7.*l5.*m7.*cos(th5 - th7) - l5.*l7.*m8.*cos(th5 - th7) - l5.*l7.*m9.*cos(th5 - th7) - l5.*l7.*m10.*cos(th5 - th7);
M(7,6,:) = - d7.*l6.*m7.*cos(th6 - th7) - l6.*l7.*m8.*cos(th6 - th7) - l6.*l7.*m9.*cos(th6 - th7) - l6.*l7.*m10.*cos(th6 - th7);
M(7,7,:) = - I7 - d7.^2.*m7 - l7.^2.*m8 - l7.^2.*m9 - l7.^2.*m10;
M(7,8,:) = - d8.*l7.*m8.*cos(th7 - th8) - l7.*l8.*m9.*cos(th7 - th8) - l7.*l8.*m10.*cos(th7 - th8);
M(7,9,:) = - d9.*l7.*m9.*cos(th7 - th9) - l7.*l9.*m10.*cos(th7 - th9);
M(7,10,:) = -d10.*l7.*m10.*cos(th7 - th10);
M(8,1,:) = - d8.*l1.*m8.*cos(th1 - th8) - l1.*l8.*m9.*cos(th1 - th8) - l1.*l8.*m10.*cos(th1 - th8);
M(8,2,:) = - d8.*l2.*m8.*cos(th2 - th8) - l2.*l8.*m9.*cos(th2 - th8) - l2.*l8.*m10.*cos(th2 - th8);
M(8,3,:) = - d8.*l3.*m8.*cos(th3 - th8) - l3.*l8.*m9.*cos(th3 - th8) - l3.*l8.*m10.*cos(th3 - th8);
M(8,4,:) = - d8.*l4.*m8.*cos(th4 - th8) - l4.*l8.*m9.*cos(th4 - th8) - l4.*l8.*m10.*cos(th4 - th8);
M(8,5,:) = - d8.*l5.*m8.*cos(th5 - th8) - l5.*l8.*m9.*cos(th5 - th8) - l5.*l8.*m10.*cos(th5 - th8);
M(8,6,:) = - d8.*l6.*m8.*cos(th6 - th8) - l6.*l8.*m9.*cos(th6 - th8) - l6.*l8.*m10.*cos(th6 - th8);
M(8,7,:) = - d8.*l7.*m8.*cos(th7 - th8) - l7.*l8.*m9.*cos(th7 - th8) - l7.*l8.*m10.*cos(th7 - th8);
M(8,8,:) = - I8 - d8.^2.*m8 - l8.^2.*m9 - l8.^2.*m10;
M(8,9,:) = - d9.*l8.*m9.*cos(th8 - th9) - l8.*l9.*m10.*cos(th8 - th9);
M(8,10,:) = -d10.*l8.*m10.*cos(th8 - th10);
M(9,1,:) = - d9.*l1.*m9.*cos(th1 - th9) - l1.*l9.*m10.*cos(th1 - th9);
M(9,2,:) = - d9.*l2.*m9.*cos(th2 - th9) - l2.*l9.*m10.*cos(th2 - th9);
M(9,3,:) = - d9.*l3.*m9.*cos(th3 - th9) - l3.*l9.*m10.*cos(th3 - th9);
M(9,4,:) = - d9.*l4.*m9.*cos(th4 - th9) - l4.*l9.*m10.*cos(th4 - th9);
M(9,5,:) = - d9.*l5.*m9.*cos(th5 - th9) - l5.*l9.*m10.*cos(th5 - th9);
M(9,6,:) = - d9.*l6.*m9.*cos(th6 - th9) - l6.*l9.*m10.*cos(th6 - th9);
M(9,7,:) = - d9.*l7.*m9.*cos(th7 - th9) - l7.*l9.*m10.*cos(th7 - th9);
M(9,8,:) = - d9.*l8.*m9.*cos(th8 - th9) - l8.*l9.*m10.*cos(th8 - th9);
...
f(10,:) = d10.*dth1.^2.*l1.*m10.*sin(th1 - th10) - d10.*g.*m10.*cos(th10) + d10.*dth2.^2.*l2.*m10.*sin(th2 - th10) + d10.*dth3.^2.*l3.*m10.*sin(th3 - th10) + d10.*dth4.^2.*l4.*m10.*sin(th4 - th10) + d10.*dth5.^2.*l5.*m10.*sin(th5 - th10) + d10.*dth6.^2.*l6.*m10.*sin(th6 - th10) + d10.*dth7.^2.*l7.*m10.*sin(th7 - th10) + d10.*dth8.^2.*l8.*m10.*sin(th8 - th10) + d10.*dth9.^2.*l9.*m10.*sin(th9 - th10);
