function [dStates, contactForces] = dynamics_flight(States, Actuators, Parameters)
% function [dStates, Actuators] = dynamics_flight(States, Actuators, Parameters)
%
...
dStates(10,:) = (L1.*M.*T2.*m1 + L1.*M.*Thip.*m1 + L1.*T2.*m1.*m2.*cos(th1 - th2).^2 + L1.*Thip.*m1.*m2.*cos(th1 - th2).^2 + L1.*T2.*m1.*m2.*sin(th1 - th2).^2 + L1.*Thip.*m1.*m2.*sin(th1 - th2).^2 - L2.*T1.*m1.*m2.*cos(th1 - th2) + L2.*Thip.*m1.*m2.*cos(th1 - th2) - L2.*M.*T1.*m2.*cos(th1 - th2).*sin(th1).^2 + L2.*M.*Thip.*m2.*cos(th1 - th2).*sin(th1).^2 - F1.*L1.*L2.*m1.*m2.*sin(th1 - th2) + L2.*M.*T1.*m2.*cos(th1).*cos(th2) - L2.*M.*Thip.*m2.*cos(th1).*cos(th2) + L2.*M.*T1.*m2.*sin(th1).*sin(th2) - L2.*M.*Thip.*m2.*sin(th1).*sin(th2) - L1.*L2.*M.*V1.*m2.*cos(th2) + L1.*L2.*M.*V2.*m1.*cos(th2) + H1.*L1.*L2.*M.*m2.*sin(th2) - H2.*L1.*L2.*M.*m1.*sin(th2) - L2.*M.*T1.*m2.*cos(th1 - th2).*cos(th1).^2 + L2.*M.*Thip.*m2.*cos(th1 - th2).*cos(th1).^2 + L1.*L2.*M.*V1.*m2.*sin(th1 - th2).*sin(th1) - F1.*L1.*L2.*M.*m2.*sin(th1 - th2).*cos(th1).^2 - F1.*L1.*L2.*M.*m2.*sin(th1 - th2).*sin(th1).^2 - F1.*L1.*L2.*M.*m2.*cos(th1).*sin(th2) + F1.*L1.*L2.*M.*m2.*cos(th2).*sin(th1) - 2.*L1.*L2.*M.*dL2.*dth2.*m1.*m2 + L1.*L2.*M.*V1.*m2.*cos(th1 - th2).*cos(th1) - H1.*L1.*L2.*M.*m2.*cos(th1 - th2).*sin(th1) + H1.*L1.*L2.*M.*m2.*sin(th1 - th2).*cos(th1))./(L1.*L2.^2.*M.*m1.*m2);
...
dStates(12,:) = (T1.*m1.*m2.*sin(th1 - th2) - Thip.*m1.*m2.*sin(th1 - th2) + F2.*L1.*M.*m1 + M.*T1.*m2.*cos(th1).*sin(th2) - M.*T1.*m2.*cos(th2).*sin(th1) - M.*Thip.*m2.*cos(th1).*sin(th2) + M.*Thip.*m2.*cos(th2).*sin(th1) + F2.*L1.*m1.*m2.*cos(th1 - th2).^2 + F2.*L1.*m1.*m2.*sin(th1 - th2).^2 - H1.*L1.*M.*m2.*cos(th2) + H2.*L1.*M.*m1.*cos(th2) - L1.*M.*V1.*m2.*sin(th2) + L1.*M.*V2.*m1.*sin(th2) + M.*T1.*m2.*sin(th1 - th2).*cos(th1).^2 - M.*Thip.*m2.*sin(th1 - th2).*cos(th1).^2 + M.*T1.*m2.*sin(th1 - th2).*sin(th1).^2 - M.*Thip.*m2.*sin(th1 - th2).*sin(th1).^2 - F1.*L1.*m1.*m2.*cos(th1 - th2) + F1.*L1.*M.*m2.*cos(th1).*cos(th2) + F1.*L1.*M.*m2.*sin(th1).*sin(th2) + H1.*L1.*M.*m2.*cos(th1 - th2).*cos(th1) + L1.*M.*V1.*m2.*cos(th1 - th2).*sin(th1) - L1.*M.*V1.*m2.*sin(th1 - th2).*cos(th1) + H1.*L1.*M.*m2.*sin(th1 - th2).*sin(th1) + L1.*L2.*M.*dth2.^2.*m1.*m2 - F1.*L1.*M.*m2.*cos(th1 - th2).*cos(th1).^2 - F1.*L1.*M.*m2.*cos(th1 - th2).*sin(th1).^2)./(L1.*M.*m1.*m2);
