...
nStep = ceil(diff(tSpan)/dtMax);  %Number of steps in simulation
t = linspace(tSpan(1),tSpan(2),nStep);  %(s) time vector for simulation
...
xlabel('Time (s)'); ylabel('Angle (rad)'); title('Simple Damped Pendulum');
